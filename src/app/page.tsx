...
export default function LandingPage() {
      ...
      navItems={[
        {
          name: "Home",          id: "hero"},
        {
          name: "Popular Dishes",          id: "features"},
        {
  ...
  <div id="hero" data-section="hero">
      ...
      avatars={[
        { src: "http://img.b2bpic.net/free-photo/medium-shot-smiley-woman-with-noodles_23-2149005440.jpg", alt: "Customer 1" },
        { src: "http://img.b2bpic.net/free-photo/girl-is-sitting-table-restaurant-drink-wine-enjoy-scent-roses-flower-waiting-date_496169-221.jpg", alt: "Customer 2" },
        { src: "http://img.b2bpic.net/free-photo/positive-young-friends-having-wine-dinner_23-2148454085.jpg", alt: "Customer 3" },
        { src: "http://img.b2bpic.net/free-photo/group-friends-eating-restaurant_23-2148006611.jpg", alt: "Customer 4" },
        { src: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_3Bf21Tt3wi4S5aiN2hhwyb4nkl1/professional-high-quality-close-up-of-bu-1774865628702-703c105d.png", alt: "Customer 5" }
      ]}
  ...
  <div id="contact" data-section="contact">
      ...
      faqs={[
        ...
        { id: "2", title: "Do you offer delivery?", content: "Yes, we offer no-contact delivery and takeout options." },
        { id: "3", title: "Do you accept reservations?", content: "Yes, please call us to book your table in advance." }
      ]}
      ctaTitle="Craving Delicious Food?"
      ctaDescription="Get in touch for table reservations or catering inquiries."
      ctaButton={{ text: "Call Now", href: "tel:+919876543210" }}
      ctaIcon={Phone}
    />
  </div>
  ...
  <div id="metric" data-section="metric">
      ...
      metrics={[
        { id: "1", value: "10K+", title: "Happy Customers", description: "Families served", icon: Users },
        { id: "2", value: "50+", title: "Unique Dishes", description: "Authentic recipes", icon: Utensils },
        { id: "3", value: "5", title: "Years Experience", description: "Serving North Delhi", icon: Award }
      ]}
    />
  </div>
  ...
  <div id="footer" data-section="footer">
      <FooterBaseReveal
      columns={[
        { title: "Location", items: [{ label: "B, 4/121, Yamuna Vihar Rd, Delhi", href: "#" }] },
        { title: "Quick Links", items: [{ label: "Home", href: "#hero" }, { label: "Menu", href: "#menu" }, { label: "Call Us", href: "tel:+919876543210" }] }
      ]}
